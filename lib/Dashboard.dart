...
void initState() { 
  ...
  _stream() {
    print("Button");
    setState(() {
    _streamUrl = 'http://192.168.43.242:8080/ozzz1.cgi';
    });
  }
  @override 
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Tommato Plant",style: TextStyle(color:Colors.black),),
        centerTitle: true,
      ),
      body: new Container(
        padding:
...
void fetchValues()async{
  var response=await http.get(Uri.http("192.168.43.242:5000", "getValues"), headers: <String, String>{
